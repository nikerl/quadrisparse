...
module quadrilatero_xif_decoder#() (
  ...
  xif_pkg::x_issue_resp_t instr_spmac_w  ;  // SPMAC_W
  ...
  xif_pkg::x_issue_resp_t instr_spld_w   ;  // SPLD
  ...
  always_comb begin: decoder_block
    unique casez (instr_i)
      ...
      quadrilatero_instr_pkg::SPMAC_W : x_issue_resp_o = instr_spmac_w ;
      ...
      quadrilatero_instr_pkg::SPLD_W  : x_issue_resp_o = instr_spld_w  ;
